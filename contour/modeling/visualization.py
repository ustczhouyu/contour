...
class Visualizer:
    ...
    def draw_contours(self, contours, data_type='predictions',
                         conf_thresh=0.5, alpha=0.8):
        """
        Args:
...
def rgb_from_pred_contours(score_fuse_feats, metadata=None, conf_thresh=0.5):
    ...
    if metadata is not None:
        color_dict = {i:thing_color
                      for i, thing_color in enumerate(metadata.thing_colors) }
...
def rgb_from_gt_contours(gt_data, medatadata=None):
